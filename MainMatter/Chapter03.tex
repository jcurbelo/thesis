...
<section data-onshow='{"func": "slowShowFrame", "args": {}}' class="frame"></section>
		...
		\label{sub:presentacion}
			Todos los frames de la presentación tienen que encontrarse dentro de un contenedor general. En la fig. \ref{fig:main_container} se define un contenedor con clase \texttt{main-container}.
