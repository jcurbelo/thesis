...
<section class="frame">Enésimo Frame</section>
			...
			Con el propósito de organizar la presentación \textit{beampress.js} analiza cada frame usando el selector \texttt{\$(".frame")} y por cada uno crea un objeto \texttt{Frame}. Los slide items hijos del frame se obtienen con el selector \texttt{\$("[data-onslide]")} y por cada uno se crea un objeto \texttt{SlideItem}. 
	...
	<body>
	   ...
	   <script>
	       $(document).ready(function(){     
			...
			El estilo de la presentación queda sujeto al usuario, por lo que se requieren previos conocimientos de HTML, CSS y Javascript. 
